...
class ProductiveReportExcell:
    ...
    def generate(self):
        ...
        worksheet.write('B5', str(self.main_details['date']))
        ...
        worksheet.write(7, 1, 'Target', f1_month)
        worksheet.write(7, 2, 'Actual', f1_month)
        worksheet.write(7, 3, 'Lst Month Actual', f1_month)
        worksheet.merge_range(6, 1, 6, 3, "Month", f1_month)

        worksheet.write(7, 4, 'Actual', f1_cumulative)
        worksheet.write(7, 5, 'Varience %', f1_cumulative)
        worksheet.merge_range(6, 4, 6, 5, "Cumulative", f1_cumulative)

        worksheet.write(8, 0, 'Days Worked', f2)
        worksheet.write(
            8, 1, self.days_worked['month']['this_target'], f2_month)
        worksheet.write(
            8, 2, self.days_worked['month']['this_actual'], f2_month)
        worksheet.write(
            8, 3,  self.days_worked['month']['last_actual'], f2_month)
        worksheet.write(
            8, 4,  self.days_worked['cumulative']['this_actual'], f2_cumulative)
        worksheet.write(8, 5,  ' ', f2_cumulative)
        ...
        worksheet.write(
            15, 1, self.callage_tot_calls['month']['this_target'], f2_month)
        worksheet.write(
            15, 2, self.callage_tot_calls['month']['this_actual'], f2_month)
        worksheet.write(
            15, 3,  self.callage_tot_calls['month']['last_actual'], f2_month)
        worksheet.write(
            15, 4,  self.callage_tot_calls['cumulative']['this_actual'], f2_cumulative)
        worksheet.write(15, 5,  ' ', f2_cumulative)

        worksheet.write(15, 0, 'Total Productive Calls', f2)
        worksheet.write(
            15, 1, self.callage_tot_productive['month']['this_target'], f2_month)
        worksheet.write(
            15, 2, self.callage_tot_productive['month']['this_actual'], f2_month)
        worksheet.write(
            15, 3,  self.callage_tot_productive['month']['last_actual'], f2_month)
        worksheet.write(
            15, 4,  self.callage_tot_productive['cumulative']['this_actual'], f2_cumulative)
        worksheet.write(15, 5,  ' ', f2_cumulative)
        ...
        for i in self.product_categories:
            ...
            worksheet.write(
                15+row, 1, self.callage_tot_products[row-1]['month']['this_target'], f2_month)

            worksheet.write(
                15+row, 2, self.callage_tot_products[row-1]['month']['this_actual'], f2_month)
            worksheet.write(
                15+row, 3,  self.callage_tot_products[row-1]['month']['last_actual'], f2_month)
            worksheet.write(
                15+row, 4,  self.callage_tot_products[row-1]['cumulative']['this_actual'], f2_cumulative)
        ...
        for i in self.product_categories:
            worksheet.write(
                new_row+row, 0, i, f2)
            worksheet.write(
                new_row+row, 1, self.avg_productive_calls[row-1]['month']['this_target'], f2_month)

            worksheet.write(
                new_row+row, 2, self.avg_productive_calls[row-1]['month']['this_actual'], f2_month)
            worksheet.write(
                new_row+row, 3,  self.avg_productive_calls[row-1]['month']['last_actual'], f2_month)
            worksheet.write(
                new_row+row, 4,  self.avg_productive_calls[row-1]['cumulative']['this_actual'], f2_cumulative)
            worksheet.write(new_row+row, 5,  ' ', f2_cumulative)
            row += 1
        workbook.close()
