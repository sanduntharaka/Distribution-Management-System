...
const ModifyPricesExcellUpload = (props) => {
    ...
    const handleUpload = async (e) => {
        ...
        axiosInstance
            .post('/distributor/items/price/excel/', formData, {
                headers: {
    ...
    return (
        <div className="fileupload" style={{ border: "1px solid black", width: 400, height: 300 }}>
...
export default ModifyPricesExcellUpload;
