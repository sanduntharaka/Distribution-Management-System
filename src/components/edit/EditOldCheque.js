...
const EditOldCheque = (props) => {
  const [editedData, setEditedData] = useState({
    ...
    cheque_deposite_date: props.data.cheque_deposite_date,
    cheque_number: props.data.cheque_number,
  });

  const handleEdit = (e) => {
    e.preventDefault();
    axiosInstance
      .put(`/pastinv/cheque/update/${props.data.id}`, editedData, {
        headers: {
          Authorization:
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  <input
                    type="text"
                    value={editedData.cheque_number}
                    onChange={(e) =>
                      setEditedData({
                        ...editedData,
              ...
              <tr>
                <td>Diposited date</td>
                <td>
                  <input
                    type="date"
                    value={editedData.cheque_deposite_date}
                    onChange={(e) =>
                      setEditedData({
                        ...editedData,
