  ...
  const handleClickDelete = (e) => {
    ...
    axiosInstance
      ...
      .then((res) => {
        ...
        props.msg('Your data deleted successfully');
        props.openMsg(true);
      })
      .catch((err) => {
        console.log(err);
        ...
        props.msg(
          'Cannot delete your details.Please check this item has some recodes in another fields.'
        );
        props.openMsg(true);
      });
  };
