...
const MonthItenery = (props) => {
    ...
    const handleDateByFilter = (e) => {
        ...
        setSuccess(false);
        axiosInstance
            .post(`/reports/salesdetails/itenery/month/`, dateBy, {
                headers: {
                    Authorization:
                        'JWT ' + JSON.parse(sessionStorage.getItem('userInfo')).access,
                },
            ...
            .then((res) => {
                ...
                setError(false);
                setSuccess(true);
                setFileName(`itenery_${monthName}`)
