...
const CreditBillsCollection = (props) => {
  ...
  const handleDateByFilter = (e) => {
    ...
    axiosInstance
      .post(`/reports/credit-collection/date/`, dateBy, {
        headers: {
          Authorization:
            'JWT ' + JSON.parse(sessionStorage.getItem('userInfo')).access,
        },
  ...
  const exportByDate = (e) => {
    ...
    const file_name = 'credit_collection_report_by_date.xlsx';
...
export default CreditBillsCollection;
