...
const ByDateRangeInvoiceTable = (props) => {
  const columns = [
    { title: 'Distributor name', field: 'distributor' },
    { title: 'Dealer name', field: 'customer_name' },
    { title: 'Invoice number', field: 'inv_number' },
    { title: 'Invoice date', field: 'inv_date' },
...
export default ByDateRangeInvoiceTable;
