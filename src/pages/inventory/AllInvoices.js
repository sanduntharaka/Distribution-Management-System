...
const AllInvoices = (props) => {
    ...
    useEffect(() => {
        ...
        if (user.is_distributor) {
            ...
            axiosInstance
                .get(
                    `/distributor/invoice/all/${props.inventory.id}`,
                    {
                        headers: {
                            Authorization:
                                'JWT ' + JSON.parse(sessionStorage.getItem('userInfo')).access,
    ...
    const handleViewDetails = (e, value) => {
        ...
        console.log(value)
        axiosInstance
            .post(`/distributor/invoice/view/${props.inventory.id}`, value, {
                headers: {
                    Authorization:
                        'JWT ' + JSON.parse(sessionStorage.getItem('userInfo')).access,
                },
            ...
            .then((res) => {
                ...
                setSataSingle(res.data.invoice);
